...
describe.runIf(operator.capability().read && operator.capability().write)('async read options', () => {
  const op = operator
...
describe.runIf(operator.capability().read && operator.capability().write)('async reader options', () => {
  const op = operator
  const capability = op.capability()
